...
CREATE TABLE `catalog` (
  ...
  `artist` varchar(25) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `country` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `company` varchar(25) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
--
ALTER TABLE `catalog`
  MODIFY `idCD` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
